      ...
      if (mode === 'login') {
        ...
        try {
          ...
          if (res.ok && data.success && data.data) {
            ...
            // If backend explicitly says wrong credentials, don't fall back to Firebase if it's not set up
            // Actually, we should just let it fallback to Firebase just in case they exist there
          }
        } catch (e) {
        ...
        try {
          ...
          if (res.ok && data.success && data.data) {
            ...
            return;
             ...
             // Fall through if backend register fails but maybe firebase will work
          }
        } catch (e) {
