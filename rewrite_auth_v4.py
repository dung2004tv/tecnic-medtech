...
export const AuthModal: React.FC<AuthModalProps> = ({ isOpen, initialMode, onClose, onLoginSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 animate-fadeIn">
      <div 
        className="bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden relative max-h-[95vh] overflow-y-auto"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Close Button */}
        <button
          onClick={onClose}
          className="absolute top-4 right-4 z-10 p-2 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-full transition"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-slate-300 focus:border-[#1a4388] focus:ring-1 focus:ring-[#1a4388] outline-none transition"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 mt-4 bg-[#1a4388] hover:bg-[#143472] text-white font-bold rounded-xl transition shadow-md disabled:opacity-50"
            >
          ...
          <div className="mt-8">
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-slate-500 font-medium">Hoặc đăng nhập bằng</span>
              </div>
            </div>
