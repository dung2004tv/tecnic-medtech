  ...
  policies: [
    {
      ...
      url: 'https://tecnic.vn/chinh-sach-ban-hang-va-chat-luong-hang-hoa',
    ...
    },
    {
      ...
      url: 'https://tecnic.vn/chinh-sach-quyen-rieng-tu-va-bao-mat-du-lieu-ca-nhan',
    ...
    },
    {
      ...
      url: 'https://tecnic.vn/chinh-sach-van-chuyen-giao-nhan-hang-hoa-tai-tecnic',
    ...
    },
    {
      ...
      url: 'https://tecnic.vn/chinh-sach-doi-tra-hang-hoa-tai-tecnic-medical',
...
export const SQL_DATABASE_SCRIPTS = {
  mySql: `
-- ==========================================================
-- CƠ SỞ DỮ LIỆU TECNIC MEDICAL (CHUẨN MYSQL 8.0+)
-- WEBSITE: tecnic.vn | PHONG CÁCH FPT LONG CHÂU
-- ==========================================================
...
`,
  sqlServerSSMS: `
-- ==========================================================
-- CƠ SỞ DỮ LIỆU TECNIC MEDICAL TRÊN MICROSOFT SQL SERVER (SSMS)
-- ==========================================================
