      ...
      <div className="space-y-1.5 flex-1 flex flex-col justify-between">
        ...
        <div className="flex items-center gap-2 text-xs pt-1">
          ...
          <span className={`text-[11px] font-bold ${
            isOutOfStock ? 'text-red-600' : (product.stock < 3 ? 'text-amber-600' : 'text-emerald-700')
          }`}>
            {isOutOfStock ? 'Trạng thái: Hết hàng' : (product.stock < 3 ? 'Trạng thái: Hàng đang về' : 'Trạng thái: Còn hàng')}
          </span>
        </div>
