...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-50 bg-white shadow-md">
      {/* 1. TOP BAR */}
      <div className="bg-[#143472] text-white text-[11px] sm:text-[12px] py-1.5 px-3 sm:px-4 border-b border-blue-900/50">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-2 sm:gap-3 overflow-hidden">
            <div className="flex items-center gap-1.5 text-white font-medium shrink-0">
              ...
              <span className="hidden xs:inline text-white font-bold">Hotline:</span>
              <a href="tel:0348402466" className="text-white text-xs sm:text-sm font-black tracking-wide hover:text-amber-300 hover:underline">
                034 84 02466
              </a>
              <span className="text-white text-xs">/</span>
              <a href="tel:0389880369" className="text-white text-xs sm:text-sm font-black tracking-wide hover:text-amber-300 hover:underline">
                038 988 0369
              </a>
            </div>
            ...
            <a 
              ...
              className="hidden lg:flex items-center gap-1.5 text-white hover:text-amber-300 font-medium truncate"
            >
          ...
          <div className="flex items-center gap-2 sm:gap-3 text-xs shrink-0">
            ...
            <button 
              ...
              className="flex items-center gap-1 text-white hover:text-amber-300 transition font-bold text-[11px] sm:text-xs"
            >
            ...
            {currentUser && (currentUser.accountType === 'ADMIN' || currentUser.accountType === 'STAFF') && onOpenAdmin && (
              <>
                ...
                <button 
                  onClick={onOpenAdmin}
                  className="hidden sm:flex items-center gap-1 text-white hover:text-amber-300 transition font-black text-[11px]"
      ...
      <div className="bg-[#0071ba] text-white py-2 sm:py-2.5 px-3 sm:px-4 shadow-sm">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-2.5 md:gap-6">
          ...
          <div className="flex items-center justify-between gap-2 w-full md:w-auto">
            ...
            <a 
              href="/" 
              className="flex items-center py-1 transition-transform active:scale-95 shrink-0"
              title="TECNIC MEDTECH - Trang chủ"
            >
              <TecnicLogo size="md" variant="dark" showSlogan={true} />
            </a>
            ...
            <div className="flex md:hidden items-center gap-2 shrink-0">
              {currentUser ? (
                <div className="relative">
                  ...
                  >
                    <div className="w-5 h-5 rounded-full bg-white text-[#0071ba] flex items-center justify-center font-black text-[10px]">
                ...
                <button
                  ...
                  className="bg-white hover:bg-blue-50 text-[#0071ba] font-black px-3 py-1 rounded-full text-xs transition shadow-xs flex items-center gap-1"
                >
          ...
          <div className="hidden md:flex items-center gap-3 shrink-0">
            ...
            {currentUser ? (
              <div className="relative">
                ...
                >
                  <div className="w-6 h-6 rounded-full bg-white text-[#0071ba] flex items-center justify-center font-black text-xs">
                    {currentUser.fullName.charAt(0).toUpperCase()}
                  </div>
              ...
              <div className="flex items-center gap-1 text-xs">
                ...
                <button
                  ...
                  className="bg-white hover:bg-blue-50 text-[#0071ba] font-bold px-3 py-1.5 rounded-r-full transition cursor-pointer"
                >
                  Đăng ký
                </button>
              </div>
