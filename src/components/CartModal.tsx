      ...
      >
        ...
        <div className="bg-[#143472] text-white px-6 py-4 flex justify-between items-center shrink-0">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-black text-base uppercase">Giỏ Hàng TECNIC</h3>
        ...
        {items.length === 0 ? (
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-4">
            ...
            {/* Free shipping banner / Bulky banner */}
            <div className={`p-2.5 rounded-xl text-xs flex items-center gap-2 border ${hasBulkyItems ? 'bg-amber-50 text-amber-800 border-amber-200' : 'bg-emerald-50 text-emerald-800 border-emerald-200'}`}>
              <Truck className={`w-4 h-4 shrink-0 ${hasBulkyItems ? 'text-amber-600' : 'text-emerald-600'}`} />
              <span>
                {hasBulkyItems 
                  ? <>⚠️ Đơn hàng có chứa <b>hàng cồng kềnh</b>, phát sinh phụ phí vận chuyển: <b>+150.000 đ</b></>
                  : <>🎉 <b>Đặc quyền:</b> Đơn hàng của bạn được <b>Miễn Phí Vận Chuyển Toàn Quốc</b> (0 đ).</>
                }
              </span>
            </div>
