  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto px-3 sm:px-6">
        ...
        {/* BOTTOM COMMODITY / VALUE PROPOSITIONS BAR */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2.5 sm:gap-3.5 pt-3">
          <div className="bg-white border border-slate-200/90 hover:border-blue-300 p-3 sm:p-3.5 rounded-2xl flex items-center gap-3 shadow-xs transition">
            <div className="w-10 h-10 rounded-xl bg-blue-50 text-[#0071ba] flex items-center justify-center shrink-0">
              <ShieldCheck className="w-5 h-5" />
            </div>
            <div>
              <p className="font-bold text-xs sm:text-sm text-slate-800">100% Chính Hãng</p>
              <p className="text-[10px] sm:text-xs text-slate-500">Giấy phép Bộ Y Tế & CO-CQ</p>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200/90 hover:border-blue-300 p-3 sm:p-3.5 rounded-2xl flex items-center gap-3 shadow-xs transition">
            ...
            <div>
              <p className="font-bold text-xs sm:text-sm text-slate-800">Giải Pháp Toàn Diện</p>
              <p className="text-[10px] sm:text-xs text-slate-500">Tái sinh cuộc sống vận động</p>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200/90 hover:border-blue-300 p-3 sm:p-3.5 rounded-2xl flex items-center gap-3 shadow-xs transition">
            ...
            <div>
              <p className="font-bold text-xs sm:text-sm text-slate-800">Bảo Hành 12 - 36 Tháng</p>
              <p className="text-[10px] sm:text-xs text-slate-500">Giao hàng toàn quốc</p>
            </div>
          </div>
        </div>

        {/* QUICK OPTION TO UPLOAD USER'S HIGH-RES RASTER BANNER FILE IF DESIRED */}
        <div className="pt-2 flex items-center justify-end">
          <label className="text-[11px] text-slate-400 hover:text-blue-600 cursor-pointer flex items-center gap-1 transition">
            <Upload className="w-3 h-3" />
            <span>Tùy chỉnh tải ảnh Banner trực tiếp (.png, .jpg)</span>
            <input 
              type="file" 
              accept="image/*" 
              className="hidden" 
